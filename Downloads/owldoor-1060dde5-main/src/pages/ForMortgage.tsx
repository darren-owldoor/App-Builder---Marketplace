...
export default function ForMortgage() {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            duration: 0.6
              ...
              <Card className="p-8 text-center bg-card mt-6">
                ...
                <Button size="lg" className="w-full bg-primary hover:bg-primary/90" onClick={() => navigate("/for-brokerages")}>
            ...
            delay: 0.2
              ...
              <div className="relative">
                <img src={realtorLenderNetwork} alt="Realtor Lender Network Map" className="w-full h-auto rounded-lg" />
              </div>
                ...
                <Card className="p-6 hover:shadow-lg transition-shadow">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <Button className="w-full bg-primary hover:bg-primary/90" onClick={() => navigate("/for-agents")}>
                        Learn More
                      </Button>
                    </div>
                  </div>
                ...
                <Card className="p-6 hover:shadow-lg transition-shadow">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <Button className="w-full bg-primary hover:bg-primary/90" onClick={() => navigate("/for-mortgage")}>
                        Sign Up
                      </Button>
                    </div>
                  </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-8 hover:shadow-lg transition-shadow">
              ...
              <Button size="lg" className="w-full bg-primary hover:bg-primary/90" onClick={() => navigate("/matching")}>
