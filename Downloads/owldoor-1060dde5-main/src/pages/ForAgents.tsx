          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            duration: 0.6
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-tight mb-4 w-full tracking-tight">
                We Can 2-5X Your <span className="text-primary text-center">  Your Production </span>
              </h1>
            ...
            delay: 0.2
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-6 text-center text-base sm:text-xl md:text-2xl font-normal">Join A Team That Provides You With Deals</p>
              </div>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            duration: 0.6
              ...
              <Card className="p-8 md:p-12 bg-background shadow-xl">
                ...
                <Button size="lg" className="w-full text-lg" onClick={openTypeform}>Sign Up Free</Button>
              </Card>
            </motion.div>
            ...
            duration: 0.6
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight text-background text-center lg:text-6xl">
                We Recruit Top Agents For The Top 10% of  National Teams{" "}
                
              </h1>
              <p className="text-lg md:text-xl text-background/90 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed text-center">
                See if we have availability in your market
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 px-6" ref={howItWorksRef}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Match With The Right Team</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Our AI-powered platform analyzes compatibility across multiple dimensions 
            </p>
          </div>
                      ...
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex-1 text-left">
                          ...
                          <p className="text-sm text-muted-foreground">
                            📍 {currentMatch.agent.location} · {currentMatch.agent.price}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <div className="text-right">
                          ...
                          <div className="flex gap-1 text-xs mt-2">
                            {currentMatch.agent.benefits.map((benefit, idx) => <span key={idx} className="text-muted-foreground">
                                • {benefit}
                              </span>)}
                          </div>
                        </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex-1 text-left">
                          ...
                          <p className="text-sm text-muted-foreground">
                            📍 {currentMatch.brokerage.location} · 👥 {currentMatch.brokerage.agents}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <div className="text-right">
                          ...
                          <div className="flex gap-1 text-xs mt-2">
                            {currentMatch.brokerage.benefits.map((benefit, idx) => <span key={idx} className="text-muted-foreground">
                                {benefit} •
                              </span>)}
                          </div>
                        </div>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-7xl">
          ...
          duration: 0.6
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Intelligent Matching</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          duration: 0.6
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to Level Up Your Closings?</h2>
