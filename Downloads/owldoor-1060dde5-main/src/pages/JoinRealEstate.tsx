...
const JoinRealEstate = () => {
  ...
  const totalSteps = 6;
  const steps = [
    { id: 1, title: "Service Areas", description: "ZIP + Radius" },
    { id: 2, title: "Company Info", description: "About Your Team" },
    ...
    switch (currentStep) {
      ...
      case 2:
        if (!formData.companyName) {
          toast.error("Please enter your company/team name");
          return false;
        }
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="companyName" className="text-gray-700 font-semibold">Company/Team Name</Label>
                <Input
                  id="companyName"
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="lookingFor" className="text-gray-700 font-semibold">
                Tell us what's most important to you in recruiting agents
              </Label>
              <textarea
                id="lookingFor"
                value={formData.lookingFor}
                onChange={e => setFormData({ ...formData, lookingFor: e.target.value })}
                placeholder="e.g., Experienced agents with strong buyer networks, top producers looking for better splits, agents wanting more leads..."
          ...
          <div className="flex-1 flex items-center justify-center relative z-10">
            <div className="w-full max-w-sm">
              <div className="bg-white/95 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-white/20">
                <h3 className="text-2xl font-bold mb-8 text-gray-900">Real Estate Team Signup</h3>
                <div className="space-y-6">
                  {steps.map(step => (
